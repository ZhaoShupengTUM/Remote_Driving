...
class PIDControlNode: public rclcpp::Node
{
    ...
    // rclcpp::Subscription<carla_msgs::msg::CarlaEgoVehicleStatus>::SharedPtr sub_carla_vehicleState;
    ...
    //state machine part
    bool vehicle_reverse {false};
    bool vehicle_collision_direction_mark {false};
    int vehicle_state{0};
    ...
    // void callback_carla_vehicle_state(const carla_msgs::msg::CarlaEgoVehicleStatus::SharedPtr msg_carla_vehState);
    #ifdef DEBUG
    double set_length{};
