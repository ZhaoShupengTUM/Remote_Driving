...
#include "traj_interfaces/msg/detail/state_machine__rosidl_typesupport_fastrtps_c.h"
...
using _StateMachine__ros_msg_type = traj_interfaces__msg__StateMachine;
...
size_t get_serialized_size_traj_interfaces__msg__StateMachine(
  const void * untyped_ros_message,
...
static uint32_t _StateMachine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_traj_interfaces__msg__StateMachine(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traj_interfaces
size_t max_serialized_size_traj_interfaces__msg__StateMachine(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_traj_interfaces__msg__StateMachine(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traj_interfaces, msg, StateMachine)() {
