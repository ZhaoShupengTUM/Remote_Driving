...
static const _StateMachine_type_support_symbol_names_t _StateMachine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traj_interfaces, msg, StateMachine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traj_interfaces, msg, StateMachine)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, traj_interfaces, msg, StateMachine)() {
  return &::traj_interfaces::msg::rosidl_typesupport_c::StateMachine_message_type_support_handle;
}
