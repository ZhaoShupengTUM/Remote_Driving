...
bool tod_msgs__msg__primary_control_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tod_msgs.msg._primary_control_cmd.PrimaryControlCmd", full_classname_dest, 51) == 0);
  }
  tod_msgs__msg__PrimaryControlCmd * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PrimaryControlCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tod_msgs.msg._primary_control_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PrimaryControlCmd");
