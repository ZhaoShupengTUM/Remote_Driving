...
bool tod_msgs__msg__colored_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tod_msgs.msg._colored_point.ColoredPoint", full_classname_dest, 40) == 0);
  }
  tod_msgs__msg__ColoredPoint * ros_message = _ros_message;
  {  // point
...
{
  /* NOTE(esteve): Call constructor of ColoredPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tod_msgs.msg._colored_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ColoredPoint");
