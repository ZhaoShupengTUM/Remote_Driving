...
#include "tod_msgs/msg/detail/object_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tod_msgs::msg::ObjectList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tod_msgs::msg::ObjectList & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        tod_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectData(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const tod_msgs::msg::ObjectList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tod_msgs::msg::ObjectList *>(
    untyped_ros_message);
...
{
  return &tod_msgs::msg::typesupport_fastrtps_cpp::_ObjectList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tod_msgs, msg, ObjectList)() {
  return &tod_msgs::msg::typesupport_fastrtps_cpp::_ObjectList__handle;
}
