...
static const _SecondaryControlCmd_type_support_symbol_names_t _SecondaryControlCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tod_msgs, msg, SecondaryControlCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tod_msgs, msg, SecondaryControlCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tod_msgs, msg, SecondaryControlCmd)() {
  return &::tod_msgs::msg::rosidl_typesupport_c::SecondaryControlCmd_message_type_support_handle;
}
