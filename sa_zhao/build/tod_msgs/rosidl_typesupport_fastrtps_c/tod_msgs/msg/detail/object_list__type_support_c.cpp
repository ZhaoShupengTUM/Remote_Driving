...
#include "tod_msgs/msg/detail/object_list__rosidl_typesupport_fastrtps_c.h"
...
#include "tod_msgs/msg/detail/object_data__functions.h"  // object_list
...
using _ObjectList__ros_msg_type = tod_msgs__msg__ObjectList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: object_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tod_msgs, msg, ObjectData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: object_list
  {
    ...
    if (ros_message->object_list.data) {
      tod_msgs__msg__ObjectData__Sequence__fini(&ros_message->object_list);
    }
...
size_t get_serialized_size_tod_msgs__msg__ObjectList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectList__ros_msg_type * ros_message = static_cast<const _ObjectList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_tod_msgs__msg__ObjectData(
...
static uint32_t _ObjectList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tod_msgs__msg__ObjectList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tod_msgs
size_t max_serialized_size_tod_msgs__msg__ObjectList(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_tod_msgs__msg__ObjectData(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_tod_msgs__msg__ObjectList(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tod_msgs, msg, ObjectList)() {
