...
#define NODE_MAIN_LOGGER_NAME "pure_pursuit_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpure_pursuit_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pure_pursuit::PurePursuitNode>";
