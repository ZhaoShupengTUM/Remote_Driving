...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_auto_planning_msgs/TrajectoryPoint, 10000>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_planning_msgs', 'msg'], 'TrajectoryPoint'), 10000),  # noqa: E501
    )
