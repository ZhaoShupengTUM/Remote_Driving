...
struct Trajectory_
{
  ...
  _header_type header;
  using _points_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, 10000, typename ContainerAllocator::template rebind<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>::other>;
  _points_type points;
  ...
  Type & set__points(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, 10000, typename ContainerAllocator::template rebind<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>::other> & _arg)
  {
    this->points = _arg;
    return *this;
  }
